...
> Answer: Lines of code are called to load the functions comprising the package
...
Include stringsAsFactors = T when importing files
  Characters are changed to factors, allows it to be treated as a category
...
str(USGS.flow.data) #compactly display structure of an arbitrary R object
dim(USGS.flow.data)
