...
>  Irradiance is significantly different at different levels of depth of water (R2=##,F(df)=##,p=##). Specifically, irradiance has a strong negative relationship with depth (t=##,df=##,p=##).
